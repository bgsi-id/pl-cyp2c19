...
zcat clair3/merge_output.vcf.gz | awk 'BEGIN{OFS="\t"} {if ($1=="chr10:94762681-94855547") {$1="chr10"; $2+=94762680} print}' - > $OUTPUT/$SAMPLE.hg38.vcf
zcat clair3/merge_output.gvcf.gz | awk 'BEGIN{OFS="\t"} {if ($1=="chr10:94762681-94855547") {$1="chr10"; $2+=94762680} print}' - > $OUTPUT/$SAMPLE.hg38.gvcf
